...
func main() {
	...
	http.HandleFunc("/register/4", h.HandlerRegisterPageFour)
	http.HandleFunc("/register/5", h.HandlerRegisterPageFive)
	...
	handleAuth("/transition/edit", h.HandlerTransitionEditPage)
	handleAuth("/transition/update", h.HandlerTransitionUpdate)
